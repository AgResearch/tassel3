...
public class ModelFitterForwardRegression extends ModelFitter {
	...
	public void writeOutputToFile() {
		...
		try {
			bw = new BufferedWriter(new FileWriter(files.chrmodel[chromosome - 1]));
...
//				System.out.println(sb.toString());
	...
	public void initializeStepFile() {
		BufferedWriter bw;
		try {
			bw = new BufferedWriter(new FileWriter(files.chrsteps[chromosome - 1]));
	...
	public void writeSNPToStepFile(SnpInfo snp) {
		BufferedWriter bw;
		try {
			bw = new BufferedWriter(new FileWriter(files.chrsteps[chromosome - 1], true));
