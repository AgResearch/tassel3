...
public class QseqToTagCountPlugin extends AbstractPlugin {  
    ...
    private void printUsage(){
        logger.info(
            ...
            + " -s  Max good, barcoded reads per lane. (Optional. Default is 300,000,000).\n"
...
//        try{
            ...
            else{ printUsage(); throw new IllegalArgumentException("Please specify the location of your .qseq files."); }
