 ...
 * @author edbuckler
 */
public class OldBiParentalErrorCorrectionPlugin extends AbstractPlugin {
    ...
    public OldBiParentalErrorCorrectionPlugin(){
        super(null, false);
    }

    public OldBiParentalErrorCorrectionPlugin(Frame parentFrame) {
...
//                    System.out.println(errorRate[s]+"\t"+pmj+"\t"+pmn+"\t"+errorP+"\t"+segP+"\t"+errVSeg[pop]);
  ...
  //          System.out.println("POP:"+pop+Arrays.toString(ldByPop[pop]));
   ...
   private void classifyTaxaToPops(String popMask) {
     ...
     */
    private void calcSNPsFreqByPop(Alignment a, String popMask, double pDevFromExp) {
...
//                "-popM","SgSBRIL",
    ...
    public static void main(String[] args) {
        ...
        OldBiParentalErrorCorrectionPlugin testClass = new OldBiParentalErrorCorrectionPlugin();
    ...
    public void setMinMedianLDR2(double minMedianLDR2) {
        ...
        myLogger.info(
            ...
            + "-popM  Population mask: a regular expression specifying which taxa to filter.  Defaults to all taxa.\n"
            + "-sC  Start chromosome\n"
            + "-eC  End chromosome\n"
            +"-mxE  Maximum error\n"
