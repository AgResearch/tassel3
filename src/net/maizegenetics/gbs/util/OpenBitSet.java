...
import java.io.Serializable;
        ...
        public class OpenBitSet implements  Cloneable, Serializable {
            ...
            private long lastCardinality=Long.MIN_VALUE;
            ...
            public void flip(long startIndex, long endIndex) {
                ...
                long endmask = (endIndex & 0x3f) == 0 ? 0
                        : -1L >>> (64 - endIndex);
          ...
          //      return BitUtil.pop_array(bits, 0, wlen);
                lastCardinality =BitUtil.pop_array(bits, 0, wlen);
                return lastCardinality;
            }

            /**
             * If the bitsets are used frequently for read and not changed this
             * provides a record of cardinality
             * @return
             */
            public long lastCalculatedCardinality() {
                if(lastCardinality>-1) return lastCardinality;
                return cardinality();
            }
            ...
            public static long intersectionCount(OpenBitSet a, OpenBitSet b) {
                return BitUtil.pop_intersect(a.bits, b.bits, 0, Math.min(
                        a.wlen, b.wlen));
            }
            ...
            public static long unionCount(OpenBitSet a, OpenBitSet b) {
                long tot = BitUtil.pop_union(a.bits, b.bits, 0, Math.min(
                        a.wlen, b.wlen));
                if (a.wlen < b.wlen) {
            ...
            public static long andNotCount(OpenBitSet a, OpenBitSet b) {
                long tot = BitUtil.pop_andnot(a.bits, b.bits, 0, Math.min(
                        a.wlen, b.wlen));
                if (a.wlen > b.wlen) {
                    tot += BitUtil.pop_array(a.bits, b.wlen, a.wlen - b.wlen);
                }
            ...
            public static long xorCount(OpenBitSet a, OpenBitSet b) {
                long tot = BitUtil.pop_xor(a.bits, b.bits, 0, Math.min(a.wlen,
                        b.wlen));
                if (a.wlen < b.wlen) {
                    tot += BitUtil.pop_array(b.bits, a.wlen, b.wlen - a.wlen);
                } else if (a.wlen > b.wlen) {
