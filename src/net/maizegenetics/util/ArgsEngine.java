...
/**
 * A reusable solution for Command Line Arguments Parsing in Java. <p> The
 * following shows how to use this API.
 *
 * <pre>
...
public class ArgsEngine {
    ...
    /**
     * Parses the input command line arguments. The result of parsing will be
     * stored in the current instance of <tt>ArgsEngine</tt>. <p>Operations
     * {@link #getBoolean(String)}, {@link #getNonOptions()} and
     * {@link #getString(String)} can be then used to extract the values.
     *
     ...
     *
     * @param key the valued option key. Either short form or long form can be
     * input.
     *
     * @return the value for the option if it's valued, <tt>null</tt> otherwise.
     */
    ...
    /**
     * An object for representing and manipulating with the options. <p> This
     * class is internal to the <tt>ArgsEngine</tt>.
     *
     * @author Adarsh Ramamurthy
     *
    ...
    private static class Option {
        ...
        /**
         * Constructs an instance of <tt>Option</tt> taking the short and long
         * forms provided.
         *
